...
static void mavlink_test_waypoint_list_count(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_waypoint_list_count_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_list_count_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.plan_id , packet1.sync_id , packet1.count );
    mavlink_msg_waypoint_list_count_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_list_count_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.plan_id , packet1.sync_id , packet1.count );
    mavlink_msg_waypoint_list_count_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_waypoint_list_count_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_waypoint_list_count_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.plan_id , packet1.sync_id , packet1.count );
    mavlink_msg_waypoint_list_count_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
