...
#define MAVLINK_MSG_ID_WAYPOINT_LIST_COUNT_LEN 4
#define MAVLINK_MSG_ID_WAYPOINT_LIST_COUNT_MIN_LEN 4
#define MAVLINK_MSG_ID_180_LEN 4
#define MAVLINK_MSG_ID_180_MIN_LEN 4

#define MAVLINK_MSG_ID_WAYPOINT_LIST_COUNT_CRC 169
#define MAVLINK_MSG_ID_180_CRC 169
...
#define MAVLINK_MESSAGE_INFO_WAYPOINT_LIST_COUNT { \
    ...
    "WAYPOINT_LIST_COUNT", \
    3, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_waypoint_list_count_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_waypoint_list_count_t, target_component) }, \
         { "count", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_waypoint_list_count_t, count) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WAYPOINT_LIST_COUNT { \
...
{
    return mavlink_msg_waypoint_list_count_pack(system_id, component_id, msg, waypoint_list_count->target_system, waypoint_list_count->target_component, waypoint_list_count->count);
}
...
{
    return mavlink_msg_waypoint_list_count_pack_chan(system_id, component_id, chan, msg, waypoint_list_count->target_system, waypoint_list_count->target_component, waypoint_list_count->count);
}
...
static inline void mavlink_msg_waypoint_list_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WAYPOINT_LIST_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_waypoint_list_count_send(chan, waypoint_list_count->target_system, waypoint_list_count->target_component, waypoint_list_count->count);
#else
 ...
 */
static inline void mavlink_msg_waypoint_list_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
